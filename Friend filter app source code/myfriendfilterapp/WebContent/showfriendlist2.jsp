...
<body>
	 ...
	 <h2>Your Friend's Like Music List!</h2>

		<c:forEach begin="0" end="${fn:length(total_myfriendmusiclist1) - 1}" varStatus="loop"> 
		 <tr>
   		 	<td> <c:out value="${i}" /> </td>
   		 	<a href="https://www.facebook.com/dialog/oauth?client_id=447748791951781&redirect_uri=http://localhost:8080/myfriendfilterapp/musicfilter2?parameterId=${total_myfriendmusiclist_nowhitespace1[loop.index]}&scope=friends_likes">${total_myfriendmusiclist1[loop.index]}</a>
   		 	<br>
   		 </tr>
  		</c:forEach>
